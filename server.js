...
//mongodb
app.post('/getsignUp',mongodbController.signUp);
app.post('/getsignIn',mongodbController.signIn);
app.get('/getprofile', mongodbController.getProfile);
app.get('/getsignOut', mongodbController.signOut);

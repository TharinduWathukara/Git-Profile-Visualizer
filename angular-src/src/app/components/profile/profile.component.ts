...
export class ProfileComponent implements OnInit, OnChanges{
  ...
  // variables to store date of user profile
  ...
  // for get repo details such size of repos, starts of repos watching of repos
  getReposDetails(){
